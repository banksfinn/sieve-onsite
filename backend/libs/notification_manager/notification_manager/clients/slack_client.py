...
class SlackNotificationClient:
    ...
    async def send_message(
        ...
        Returns:
            SlackMessage with channel, ts, and text
    ...
    async def send_reply(
        ...
        This is a convenience wrapper around send_message that requires thread_ts.
    ...
    async def get_user_by_id(self, user_id: str) -> SlackUser:
        ...
        Returns:
            SlackUser with user information

        Raises:
            SlackApiError: If the API call fails (e.g., user not found)
        """
    ...
    async def search_channels(self, query: str, limit: int = 20) -> list[SlackChannel]:
        ...
        Returns:
            List of SlackChannel objects matching the query
        """
    ...
    async def send_dm(self, user_email: str, text: str) -> SlackMessage:
        ...
        Raises:
            SlackApiError: If any API call fails (user not found, etc.)
        """
