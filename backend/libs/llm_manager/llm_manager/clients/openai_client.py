...
class OpenAIProvider(LLMProvider):
    ...
    async def chat(
        ...
        # Convert to OpenAI format and call SDK
        ...
        # Parse to generic response then to LLMMessage
    ...
    def build_request(
        ...
        # Convert LLMMessages to ProviderMessages
        for msg in messages:
    ...
    def _llm_message_to_provider(self, msg: LLMMessage) -> list[ProviderMessage]:
        """Convert an LLMMessage to ProviderMessage(s)."""
    ...
    def _to_openai_tools(self, tools: list[ProviderTool]) -> list[dict[str, Any]]:
        """Convert ProviderTools to OpenAI format."""
        return [
            {
                "type": tool.type,
                "function": {
    ...
    def _from_openai_response(self, response: Any) -> ProviderChatResponse:
        """Convert OpenAI response to ProviderChatResponse."""
