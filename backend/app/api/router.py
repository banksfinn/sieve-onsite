...
from app.api.routes.dataset_review import router as dataset_review_router
...
api_router.include_router(dataset_review_router, tags=["dataset_review"], prefix="/dataset")
